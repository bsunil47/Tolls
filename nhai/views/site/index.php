...
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs graphMain">
            ...
            <div class="graphBox UserCompAnaly"><img width="280px" src="<?php echo Yii::$app->request->baseUrl; ?>/images/groph2_360.png"/></div>
            <div class="graphBox axelUsersAnaly"><img width="220px" src="<?php echo Yii::$app->request->baseUrl; ?>/images/graph1_360.png"/></div>
        </div>
                ...
                <div class="map-wrapper">
                    ...
                    <div class="google-map-overlay" ng-show="showState">
                            ...
                            <div class="grid-list">
                                ...
                                <div class="grid-view-concessioner-list" ng-repeat="toll in searchedList"><a href="site/report?id={{toll.toll_id}}" style="text-decoration: none; color:#181818"><div>{{toll.toll_name}} / {{toll.toll_stretch}}</div><div>{{toll.toll_location}}</div></a></div>
