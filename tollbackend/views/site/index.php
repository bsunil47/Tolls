    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 p0" ng-controller="Ctrl2" >
                <span class="date" my-current-time="dateformat" style="color:#ff9600; font-weight: 600;font-family: OMUPro-Light"></span> </br>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 p0 tr" style="text-align: right;">
                ...
                <div class="login-user-text disinblo" style="float:right;">
                    ...
                    <div align="left" style="padding-left: 10px;"><a href="<?php echo Yii::$app->request->baseUrl; ?>/site/logout">Logout</a></div>
                </div>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs graphMain">
            ...
            <div class="graphBox UserCompAnaly">
                <div id="chart" style="width:100%;height: 200px;"></div>
<!--                <fusioncharts id="chartcontainer" chartid="chart1" width="100%" height="200" type="column2d" dataFormat= 'json' dataSource="{{dataSource}}" config="{{chartoptions}}"></fusioncharts>-->
<!--<img width="280px" src="<?php //echo Yii::$app->request->baseUrl; ?>/images/groph2_360.png"/>--></div>
            <div class="graphBox axelUsersAnaly">
                ...
                <!--<img width="220px" src="<?php //echo Yii::$app->request->baseUrl; ?>/images/graph1_360.png"/>-->
<!--            <fusioncharts id="chartcontainer" chartid="chart1" width="100%" height="200" type="column2d" dataFormat= 'json' dataSource="{{vdataSource}}" config="{{chartoptions}}"></fusioncharts>-->
            </div>
        </div>
                ...
                <div class="header2">
                    <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs">
                        <div style="margin:26px 0 0 0; font-family:OMUPro-Light; color:#FFFFFF;">
                            <div style="font-size:40px;">{{TollsIndiaCount}}</div><div style="font-size:22px; padding-left:8px;">Tollered</div>
                        </div>
                    </div>
...
<!--                        <form>
                            ...
                            <div id="state" style="" ng-show="showState">
                                <div style="padding-top:40px;">
                                    <select class="search-by"  ng-model="filterCondition.operator" ng-options="state.short_code as state.state for state in states | filter:search | uppercase" ng-change="ChangedState(states, filterCondition.operator)">

                                    </select>
                                </div>
                            </div>
                            <div id="direction" style="" ng-hide="showState">
                                <div><input type="text" class="starting-point" placeholder="choose starting point" g-places-autocomplete ng-model="fromPoint"><span ></span></div>
                                <div><input type="text" class="disti-point" placeholder="choose destination" g-places-autocomplete ng-model="toPoint"><span ><button class="point-point-but" ng-click="findTolls()">Find</button></span></div>
                            </div>
                        </form>-->
                    </div>
                </div>
                <div class="map-wrapper">
                    ...
                    <div class="google-map-overlay" ng-show="showState">
                            ...
                            <div>
                                <input class="txt-fld" name="" placeholder="search concessioner name" type="text" ng-model="tollName" ng-change="searchToll(tollList,tollName)"/>
                            </div>
                            <div class="grid-list">
                                <div style="height:30px;"></div>
                                <div class="grid-view-concessioner-list" ng-repeat="toll in searchedList"><a href="tollapp/site/report?id={{toll.toll_id}}" style="text-decoration: none; color:#181818"><div>{{toll.toll_name}} / {{toll.toll_stretch}}</div><div>{{toll.toll_location}}</div></a></div>
