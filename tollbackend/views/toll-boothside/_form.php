...
<div class="toll-boothside-form">
    ...
    <span class="col-sm-12"><?= $form->field($model, 'toll_id')->dropDownList($dataTolls,['prompt'=>'-Choose a Category-','onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl('toll-boothside/boothsidecount?id=').'"+$(this).val(), function( data ) {
                if(data >= 2){
