    ...
    public function actionHistorydetails(){
        ...
        if($model){
            ...
            if(!empty($gethddetails) &&!empty($gethdetails)){
                ...
                if($tollcost['counter']==1){$hdscounter=$gethddetails[$countersinglefeild]+1;}
                if($tollcost['counter']==2){$hddcounter=$gethddetails[$counterdoublefeild]+1;}
                if($tollcost['counter']==3){$hdmcounter=$gethddetails[$countermonthlyfeild]+1;}
                ...
                $hddcounter=0;
                $hdmcounter=0;
                if($tollcost['counter']==1){$hdscounter=1;}
                if($tollcost['counter']==2){$hddcounter=1;}
                if($tollcost['counter']==3){$hdmcounter=1;}
                ...
                if($model2->save() && $model1->save()){
                    $output = ["Code" => 200, "Message" => "Successfully added"];
                }else{$output = ["Code" => 400,"Message" => "Try Again"];}return $output;
            }
        }
    }
