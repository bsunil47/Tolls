    ...
    <div class="frmBox">
        ...
        <div class="inpFrm">
            ...
            <?php $form = ActiveForm::begin(['id' => 'login-form','action' => Yii::$app->homeUrl.'site/login']); ?>
                <input type="email" name="username" ng-model="user.employee_id" class="inpTxt" placeholder="Email" required>
                <input type="password" name="password" ng-model="user.password" class="inpTxt" placeholder="Password" required>
