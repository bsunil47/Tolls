    ...
    <div class="login-info">
        <div >
           <?php //echo Yii::$app->request->hostInfo.'Toll_Dev/common/profile_pic/'.'user_'.Yii::$app->user->identity->user_id.'.jpg'; ?>
            <div class="cap"><?php echo Yii::$app->user->identity->firstname." ".Yii::$app->user->identity->lastname; ?></div>
            <div class="user" style="height:60px;width:73px" ng-style="{'background-color':logincolor}" set-class-when-at-bottom="fix-to-bottom"  popover-placement="bottom" popover-is-open="{{popoverIsOpen}}" ng-mouseleave="closeSignoutMenu()" ng-mouseenter="openSignoutMenu()" ng-click="openSignoutMenu()"><img  src="<?php if(file_exists(Yii::$app->request->hostInfo.'/Tolls_Dev/common/profile_pic/'.'user_'.Yii::$app->user->identity->user_id.'.jpg') !== false){ echo Yii::$app->request->hostInfo.'/Tolls_Dev/common/profile_pic/'.'user_'.Yii::$app->user->identity->user_id.'.jpg'; }else{ echo Yii::$app->homeUrl.'images/user.png'; } ?>" width="43" height="42" class="img-circle"/></div>
            <div class="popover fade {{popoverIsOpen}} bottom" style="top: 80px; left:84%;" ng-mouseenter="openSignoutMenu()" ng-mouseleave="closeSignoutMenu()">
                <div class="arrow"></div>

                <div class="popover-inner">
                    <!-- ngIf: title -->
                    <div tooltip-template-transclude-scope="originScope()" uib-tooltip-template-transclude="contentExp()" class="popover-content"><div style="margin: 20px;" class="form-group signout-menu ng-scope">
...
<toll-tabs>
            ...
            <div id="breadcrumbs">
              ...
              <span class="input-group-btn">
                <button type="button" class="btn btn-default" ng-click="open2()"><i
                        ...
                        <span class="col-md-1"><button class="btn myButton" ng-click="findHistory(from_date, to_date)">FIND</button></span>
                    </div>
                </div>
                ...
                <uib-accordion close-others="oneAtATime">
                    ...
                    <uib-accordion-group ng-repeat="historydetails in history" is-open="status.open">
                        <uib-accordion-heading>
                            <div class="tab-row row"><span class="col-md-3">{{historydetails.travel_date}}</span><span
    ...
    <toll-panes title="Trip Favorities">
        <div  ng-controller="Favorite">
            ...
            <div class="content">
                <div class="tab-header row">
                    <span class="col-md-5">From</span><span class="col-md-5">To</span><span class="col-md-2">name</span>
                    <!--<span
                        class="col-md-1">Details</span>-->
                </div>
                <uib-accordion close-others="oneAtATime">
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-5">
                            <p class="input-group col-md-12">
                                <select class="form-control " ng-model="vehical_sele_type"  ng-change="changetype(vehical_sele_type)"  ng-options="type.vechical_types_id as type.type for type in vehicles_types">
            ...
            <div class="content" >
                <div class="tab-header row">
                    <span class="col-md-3">Vechical No</span><span
                        class="col-md-3">Nick Name</span><span class="col-md-3">Vechical Type</span><span class="col-md-2">Date Added</span><span
                        class="col-md-2"></span>
                </div>
                <div class="tab-row row" ng-repeat="vehicle in vehicles"><span
                        ...
                        class="col-md-2">{{vehicle.created_on}}</span><span class="col-md-1"><span class="col-md-6"><i
                                class="fa fa-pencil" ng-click="inEditedClass(vehicle.vechical_id)"></i></span><span class="col-md-6"><i class="fa fa-remove" ng-click="removeVehicle(vehicle.vechical_id)"></i></span></span>
                </div>
            </div>
        </div>
    </toll-panes>
        ...
        <ul>
            <li ng-repeat="pane in panes">
                <div class="nav" ng-class="{active:pane.selected}"><a href="#"
                                                                      ng-click="select(pane)">{{pane.title}}</a></div>
            </li>
    ...
    <div class="container">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" ng-click="removeinClass()">&times;</button>
                        <h4 class="modal-title">Add Vehicle</h4>
                    </div>
                    <div class="modal-body">
                        <form name="vehiAdd" >
                            <div class="form-group" ng-class="{ 'has-error' : vehiAdd.registration_no.$invalid && !vehiAdd.registration_no.$pristine }">
                                <input type="text" class="form-control" id="" placeholder="Enter Vehical Number (AP36AP7079)" ng-model="vehi.registration_no" name="registration_no" required ng-required="true">
                                <p ng-show="isRegNo" class="help-block he-reg-block">Registration No is required.</p>
                            </div>
                            <div class="form-group"  ng-class="{ 'has-error' : vehiAdd.vechical_type_id.$invalid && !vehiAdd.vechical_type_id.$pristine }">
                                <select class="form-control " ng-model="vehi.vechical_type_id"  ng-change="changetype(vehi.type)"  ng-options="type.vechical_types_id as type.type for type in vehicles_types" name="vechical_type_id" required>
                                    <option value="">Select Type</option>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="Enter Vehical Nick Name" ng-model="vehi.vechical_nickname" name="vechical_nickname">
                            </div>
                            <div class="form-group">
                                <input type="file"  id="" placeholder="Enter Vehical Nick Name" ng-files="getTheFiles($files)">
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade {{inEditClass}}" id="myModal" role="dialog" style="display: {{displayEditN}}">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" ng-click="removeinEditClass()">&times;</button>
                        <h4 class="modal-title">Edit Vehicle</h4>
                    </div>
                    <div class="modal-body">
                        <form role="form">
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="Enter Vehical Number (AP36AP7079)" value="{{vehiEditre}}" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="" value="{{vehiEdittype}}" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" ng-model="vehi.vechical_nickname"  id="" placeholder="Enter Vehical Nick Name" />
                            </div>
                            <div class="form-group">
                                <input type="file" name="file" id="" ng-files="getTheFiles($files)" placeholder="Enter Vehical Nick Name" >
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" ng-click="updatevech(vehiEditid)">Update</button>
                    </div>
                </div>
